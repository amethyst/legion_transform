...
impl Transform {
    ...
    ///
    /// ```rust
    /// # use legion_transform::Transform;
    /// # use legion_transform::math::{Isometry3, Translation3, UnitQuaternion, Vector3};
    ...
    /// ```rust
    /// # use legion_transform::Transform;
    /// # use legion_transform::math::{UnitQuaternion, Quaternion, Vector3};
...
/// ```
/// # use legion_transform::Transform;
/// # use legion_transform::math::Vector3;
